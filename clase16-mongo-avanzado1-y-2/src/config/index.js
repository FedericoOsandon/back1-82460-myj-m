...
export const connectDB = async () => {
    try {
        ...
        // ])
        /// endpoint -> recibir parametros o query
        // const size = 'small'
        // const orders = await ordersModel.aggregate([
        //     { $match: {size}}, //stage (pasos)
        //     { $group: {_id: "$name", totalQuantity: {$sum: "$quantity"}}}, // $ -> funciona como el this
        //     { $sort: {totalQuantity: -1}},
        //     { $group: {_id: 1, orders: {$push: "$$ROOT"}} }, // -> valor el input del sgte paso
